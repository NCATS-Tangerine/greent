...
export CELERY_BROKER_URL="redis://$BROKER_HOST:$BROKER_PORT/$BUILDER_REDIS_DB"
export CELERY_RESULT_BACKEND="redis://$BROKER_HOST:$BROKER_PORT/$BUILDER_REDIS_DB"
export FLOWER_BROKER_API="redis://$BROKER_HOST:$BROKER_PORT/$BUILDER_REDIS_DB"
