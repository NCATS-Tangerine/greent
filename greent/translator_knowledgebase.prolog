...
translates(doid,              pharos_id,       "core.disease_ontology.doid_to_pharos")
translates(doid,              mesh_disease_id, "core.disease_ontology.doid_to_mesh")
translates(mesh_disease_name, mesh_drug_name,  "core.chemotext.disease_name_to_drug_name")
translates(mesh,              thing,           "core.chemotext.term_to_term")
translates(pharos_target_id,  hgnc_id,         "core.pharos.get_target_hgnc")

translates(doid,              cbr_gene,        "core.pharos.disease_to_target")
translates(cbr_drug_name,     cbr_gene,        "core.chembio_ks.drug_name_to_gene_symbol")
translates(pharos_disease_id, hgnc_gene,       "core.pharos.disease_to_target")
translates(cbr_gene,          cbr_pathway,     "core.chembio_ks.gene_symbol_to_pathway")
translates(cbr_gene,          cbr_pathway,     "core.pharos.target_to_disease")
translates(cbr_gene,          hetio_anatomy,   "core.hetio.gene_to_anatomy")
translates(cbr_gene,          hetio_cell,      "core.hetio.gene_to_cell")
