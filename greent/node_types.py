...
node_types = set([DRUG, GENE, PATHWAY, PROCESS, FUNCTION, PROCESS_OR_FUNCTION, CELL, ANATOMY, PHENOTYPE, DISEASE, GENETIC_CONDITION, DRUG_NAME, DISEASE_NAME, PHENOTYPE_NAME, UNSPECIFIED])
